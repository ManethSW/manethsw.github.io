...
placeOrderButton.addEventListener('click', function () {
    if (fullNameInput.classList.contains("success") && phoneNumberInput.classList.contains("success") && emailInput.classList.contains("success") && emailConfirmInput.classList.contains("success") && dateOption.classList.contains("success")) {
        ...
        backdropThankyou.style.display = "initial";
        window.setTimeout(function () {
            thankYouMessage.style.opacity = `1`
            thankYouMessage.style.transform = `scale(1)`;
            backdropThankyou.style.opacity = `1`
        }, 0)
...
thankYouMessageClose.addEventListener('click', function () {
    ...
    backdropThankyou.style.opacity = `0`
    window.setTimeout(function () {
        thankYouMessage.style.display = "none";
        backdropThankyou.style.display = "none";
    }, 700)
});
...
const backdropLoyalty = document.getElementById(`backdrop-loyalty`);
...
closeLoyalty.addEventListener(`click`, function () {
    ...
    backdropLoyalty.style.opacity = `0`
    window.setTimeout(function () {
        loyaltyPointsSummary.style.display = `none`;
        backdropLoyalty.style.display = `none`;
    }, 700)
})